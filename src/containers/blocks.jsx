...
import myToolboxBlock_1 from '../lib/myToolboxBlock_1.jsx';
import {getCurrentGateConfigProp} from '../myprojects/gate-config';
...
class Blocks extends React.Component {
    ...
    componentDidMount () {
        ...
        this.props.vm.extensionManager.loadExtensionURL(getCurrentGateConfigProp('gateExtenseBlock'));
    ...
    getToolboxXML () {
        ...
        try {
            ...
            return myToolboxBlock_1(target.isStage, target.id, dynamicBlocksXML,
